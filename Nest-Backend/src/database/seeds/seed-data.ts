...
import {
  DeliveryCharge,
  DeliveryChargeType,
} from '../../modules/delivery-charges/entities/delivery-charge.entity';
...
async function seed() {
  ...
  const userData = [
    ...
    },
    {
      ...
      firstName: 'Hassan',
      lastName: 'Ahmad',
      email: 'hassan.ahmad@example.com',
      mobile: '+971508888888',
    },
    {
      id: U.user9,
    ...
    },
    {
      ...
      firstName: 'Yusuf',
      lastName: 'Nasser',
      email: 'yusuf.nasser@example.com',
      mobile: '+971500000001',
    },
  ];
  ...
  const brandData = [
    {
      ...
      name: 'Nike',
      slug: 'nike',
      description: 'American sportswear giant',
    },
    {
      id: U.brand2,
      name: 'Adidas',
    ...
    },
    {
      ...
      name: 'Puma',
      slug: 'puma',
      description: 'German athletic brand',
    },
    {
      id: U.brand4,
      name: 'Under Armour',
      slug: 'under-armour',
      description: 'American sports clothing',
    },
    {
      id: U.brand5,
      name: 'Reebok',
    ...
    },
    {
      ...
      name: 'ASICS',
      slug: 'asics',
      description: 'Japanese sportswear brand',
    },
    {
      id: U.brand8,
      name: 'Columbia',
      slug: 'columbia',
      description: 'Outdoor recreation brand',
    },
    {
      id: U.brand9,
      name: 'The North Face',
      slug: 'the-north-face',
      description: 'Outdoor clothing brand',
    },
    {
      id: U.brand10,
      name: 'Wilson',
  ...
  const brands = await Promise.all(
    brandData.map(async (d) => {
      const exists = await brandRepo.findOne({ where: { slug: d.slug } });
      if (!exists)
        return brandRepo.save(brandRepo.create({ ...d, isActive: true }));
      return exists;
    }),
  );
  ...
  const catData = [
    ...
    },
    {
      ...
      name: 'Football',
      slug: 'football',
      description: 'Football boots & kits',
      sortOrder: 2,
    },
    {
      id: U.cat3,
      name: 'Basketball',
      slug: 'basketball',
      description: 'Basketball shoes & apparel',
      sortOrder: 3,
    },
    {
      id: U.cat4,
      name: 'Training & Gym',
      slug: 'training-gym',
      description: 'Workout clothing & accessories',
      sortOrder: 4,
    },
    {
      id: U.cat5,
  ...
  const cats = await Promise.all(
    catData.map(async (d) => {
      ...
      if (!exists)
        return catRepo.save(catRepo.create({ ...d, isActive: true }));
      return exists;
    }),
  );
  ...
  const subs = await Promise.all(
    subData.map(async (d) => {
      ...
      if (!exists)
        return subRepo.save(subRepo.create({ ...d, isActive: true }));
      return exists;
    }),
  );
  ...
  const attrs = await Promise.all(
    attrData.map(async (d) => {
      const exists = await attrRepo.findOne({ where: { slug: d.slug } });
      if (!exists)
        return attrRepo.save(attrRepo.create({ ...d, sortOrder: 0 }));
      return exists;
    }),
  );
  ...
  const avs = await Promise.all(
    avData.map(async (d) => {
      const exists = await avRepo.findOne({
        where: { slug: d.slug, attributeId: d.attributeId },
      });
  ...
  const prodData = [
    {
      ...
      description: 'Responsive everyday running shoe with Zoom Air cushioning',
      shortDescription: 'Everyday running shoe',
      basePrice: 5499,
      salePrice: 4399,
      sku: 'NIKE-PEG-40',
    ...
    },
    {
      ...
      brandId: U.brand1,
      categoryId: U.cat4,
      subCategoryId: U.sub7,
      name: 'Nike Dri-FIT Training Tee',
      slug: 'nike-dri-fit-training-tee',
      description: 'Moisture-wicking training t-shirt for intense workouts',
      shortDescription: 'Training t-shirt',
      basePrice: 1499,
      salePrice: 1199,
      sku: 'NIKE-DF-TEE',
      status: ProductStatus.ACTIVE,
    ...
    },
    {
      ...
      description: 'Precision football boot with Demonskin rubber elements',
      shortDescription: 'Football boot',
      basePrice: 6999,
      salePrice: 5599,
      sku: 'ADIDAS-PRED-EDGE',
      status: ProductStatus.ACTIVE,
      isActive: true,
      isFeatured: true,
      sortOrder: 3,
    },
    {
      ...
      name: 'Adidas Running Ultraboost Light',
      slug: 'adidas-ultraboost-light',
      description: 'Ultra-comfortable running shoe with Light BOOST midsole',
    ...
    },
    {
      ...
      brandId: U.brand3,
      categoryId: U.cat3,
      subCategoryId: U.sub5,
      name: 'Puma Court Pro Basketball Shoe',
      slug: 'puma-court-pro-basketball',
      description: 'High-top basketball shoe with cushioned support',
      shortDescription: 'Basketball shoe',
      basePrice: 4999,
      salePrice: 3999,
      sku: 'PUMA-CP-HOOP',
      status: ProductStatus.ACTIVE,
    ...
    },
    {
      ...
      categoryId: U.cat4,
      subCategoryId: U.sub7,
      name: 'Under Armour Rush Seamless Leggings',
      slug: 'ua-rush-seamless-leggings',
      description: 'Seamless training leggings with mineral-infused fabric',
      shortDescription: 'Training leggings',
      basePrice: 3499,
      salePrice: 2799,
      sku: 'UA-RUSH-LEG',
      status: ProductStatus.ACTIVE,
    ...
    },
    {
      ...
      brandId: U.brand5,
      categoryId: U.cat4,
      subCategoryId: U.sub8,
      name: 'Reebok Weightlifting Belt',
      slug: 'reebok-weightlifting-belt',
      description: 'Premium leather weightlifting belt for heavy lifts',
      shortDescription: 'Weightlifting belt',
      basePrice: 2999,
      salePrice: 2499,
      sku: 'REEBOK-WLBELT',
      status: ProductStatus.ACTIVE,
    ...
    },
    {
      ...
      slug: 'nb-fresh-foam-1080v12',
      description: 'Plush cushioned running shoe with Fresh Foam midsole',
      shortDescription: 'Cushioned running shoe',
      basePrice: 6499,
      salePrice: 5199,
      sku: 'NB-1080V12',
      status: ProductStatus.ACTIVE,
    ...
    },
    {
      ...
      description: 'Premium cushioned running shoe with PureGEL technology',
    ...
    },
    {
      ...
      brandId: U.brand8,
      categoryId: U.cat6,
      subCategoryId: U.sub11,
      name: 'Columbia Voyager Jacket',
      slug: 'columbia-voyager-jacket',
      description: 'Waterproof breathable jacket for outdoor adventures',
      shortDescription: 'Waterproof jacket',
      basePrice: 4499,
      salePrice: 3599,
      sku: 'COL-VOYAGER-JKT',
      status: ProductStatus.ACTIVE,
    ...
    },
    {
      ...
      brandId: U.brand9,
      categoryId: U.cat6,
      subCategoryId: U.sub12,
      name: 'The North Face Hiking Boots',
      slug: 'tnf-hiking-boots',
      description: 'Sturdy waterproof hiking boots with Vibram soles',
      shortDescription: 'Hiking boots',
      basePrice: 8999,
      salePrice: 7199,
      sku: 'TNF-HIKE-BOOT',
      status: ProductStatus.ACTIVE,
    ...
    },
    {
      ...
      brandId: U.brand10,
      categoryId: U.cat3,
      subCategoryId: U.sub6,
      name: 'Wilson Evolution Basketball Jersey',
      slug: 'wilson-evolution-jersey',
      description:
        'Official game basketball jersey with moisture-wicking fabric',
    ...
    },
    {
      ...
      name: 'Adidas Arsenal Home Kit 2025/26',
      slug: 'adidas-arsenal-away-kit-2526',
      description: 'Official Arsenal home jersey with heat-sealed crest',
      shortDescription: 'Football kit',
      basePrice: 3999,
      salePrice: 3199,
      sku: 'ADIDAS-ARS-HOME',
      status: ProductStatus.ACTIVE,
    ...
    },
    {
      ...
      brandId: U.brand1,
      categoryId: U.cat5,
      subCategoryId: U.sub9,
      name: 'Nike Swim Jammer',
      slug: 'nike-swim-jammer',
      description: 'Competition swim jammer with water-repellent finish',
      shortDescription: 'Swim jammer',
      basePrice: 1999,
      salePrice: 1599,
      sku: 'NIKE-SWIM-JAM',
      status: ProductStatus.ACTIVE,
    ...
    },
    {
      ...
      categoryId: U.cat4,
      subCategoryId: U.sub7,
      name: 'Puma Studio Yoga Mat',
      slug: 'puma-studio-yoga-mat',
  ...
  for (let i = 0; i < prods.length; i++) {
    ...
    if (existing === 0) {
      await imgRepo.save(
        imgRepo.create({
          productId: p.id,
          imageUrl: `https://picsum.photos/seed/${p.slug}-1/800/800`,
          altText: p.name,
          sortOrder: 1,
          isPrimary: true,
        }),
      ...
      await imgRepo.save(
        imgRepo.create({
          productId: p.id,
          imageUrl: `https://picsum.photos/seed/${p.slug}-2/800/800`,
          altText: `${p.name} - Angle`,
          sortOrder: 2,
          isPrimary: false,
        }),
      );
    ...
    if (existing === 0) {
      ...
      await pvaRepo.save(
        pvaRepo.create({
          variantId: v.id,
          attributeId: aid(2),
          attributeValueId: isBlack ? avid(8) : avid(9),
        }),
      );
      await pvaRepo.save(
        pvaRepo.create({
          variantId: v.id,
          attributeId: aid(1),
          attributeValueId: isM ? avid(5) : avid(6),
        }),
      );
      pvaCount += 2;
    }
  ...
  for (let i = 0; i < prods.length; i++) {
    ...
    if (existing === 0) {
      ...
      await ptmRepo.save(
        ptmRepo.create({ productId: p.id, tagId: tags[tagIdx].id }),
      );
      ptmCount++;
      if (i + 1 < tags.length) {
        await ptmRepo.save(
          ptmRepo.create({
            productId: p.id,
            tagId: tags[(tagIdx + 1) % tags.length].id,
          }),
        );
        ptmCount++;
      }
  ...
  const collData = [
    {
      ...
      description: 'Gear up for summer sports',
    },
    {
      name: 'Running Collection',
      slug: 'running-collection',
      description: 'Everything for runners',
    },
    {
      name: 'Football Fan Favorites',
      slug: 'football-fan-favorites',
      description: 'Top football gear',
    },
    {
      name: 'Gym Warriors',
      slug: 'gym-warriors',
      description: 'Training equipment & apparel',
    },
    {
  ...
  const colls = await Promise.all(
    collData.map(async (d) => {
      const exists = await collRepo.findOne({ where: { slug: d.slug } });
      if (!exists)
        return collRepo.save(collRepo.create({ ...d, isActive: true }));
      return exists;
    }),
  );
  ...
  for (let i = 0; i < prods.length; i += 3) {
    ...
    const existing = await pcRepo.findOne({
      where: { productId: prods[i].id, collectionId: colls[ci].id },
    });
    if (!existing) {
      await pcRepo.save(
        pcRepo.create({ productId: prods[i].id, collectionId: colls[ci].id }),
      );
      pcCount++;
    }
  }
  ...
  const whData = [
    {
      ...
      code: 'DXB-MAIN',
      phone: '+97148001111',
      email: 'warehouse-dxb@sports.com',
    ...
    },
    {
      ...
      code: 'AUH-DIST',
      phone: '+97128002222',
      email: 'warehouse-auh@sports.com',
      address: 'ICAD Industrial City',
      city: 'Abu Dhabi',
      state: 'Abu Dhabi',
      country: 'UAE',
      postalCode: '00000',
  ...
  const addrData = [
    ...
    },
    {
      ...
      phone: '+971502222222',
      addressLine1: 'Apartment 304, Al Reem Island',
      city: 'Abu Dhabi',
      state: 'Abu Dhabi',
      country: 'UAE',
      postalCode: '00000',
    ...
    },
    {
      ...
      phone: '+971503333333',
      addressLine1: 'Building 7, The Pearl',
      city: 'Doha',
      state: 'Doha',
      country: 'Qatar',
      postalCode: '00000',
    ...
    },
    {
      ...
      phone: '+971504444444',
      addressLine1: 'Office 201, Sama Tower',
      city: 'Dubai',
      state: 'Dubai',
      country: 'UAE',
      postalCode: '00000',
    ...
    },
    {
      ...
      phone: '+971505555555',
      addressLine1: 'Flat 15, Marina Walk',
      city: 'Dubai',
      state: 'Dubai',
      country: 'UAE',
      postalCode: '00000',
  ...
  const suppData = [
    {
      name: 'SportDirect Trading',
      code: 'SPORT-DIRECT',
      email: 'info@sportdirect.ae',
      phone: '+97148001001',
    ...
    },
    {
      name: 'ProFit FZCO',
      code: 'PROFIT-FZCO',
      email: 'orders@profit.ae',
      phone: '+97148002002',
      contactPerson: 'John Smith',
      isActive: true,
    },
    {
      name: 'Global Sports LLC',
      code: 'GLOBAL-SPORT',
    ...
    {
      name: 'Elite Fitness ME',
      code: 'ELITE-FIT-ME',
      email: 'contact@elitefitness.ae',
      phone: '+97148005005',
      contactPerson: 'Aisha Rahman',
      isActive: true,
    },
    {
      name: 'Outdoor Pro Supplies',
      code: 'OUTDOOR-PRO',
      email: 'info@outdoorpro.ae',
      phone: '+97148006006',
      contactPerson: 'Tom Wilson',
      isActive: true,
    },
    {
      name: 'Team Sport Trading',
      code: 'TEAM-SPORT',
      email: 'orders@teamsport.ae',
      phone: '+97148007007',
      contactPerson: 'Hassan Al Mansouri',
      isActive: true,
    },
    {
      name: 'Aqua Sports ME',
      code: 'AQUA-SPORT-ME',
      email: 'info@aquasports.ae',
      phone: '+97148008008',
      contactPerson: 'Lisa Bennett',
      isActive: true,
    },
  ];
  const suppliers = await Promise.all(
    suppData.map(async (d) => {
      const exists = await suppRepo.findOne({ where: { code: d.code } });
      if (!exists)
        return suppRepo.save(suppRepo.create({ ...d, address: 'Dubai, UAE' }));
      return exists;
    }),
  );
  ...
  const poData = [
    {
      ...
      notes: 'Q1 restock - running shoes',
    },
    {
      poNumber: 'PO-2026-0002',
      supplierId: suppliers[1].id,
      status: PurchaseOrderStatus.APPROVED,
      notes: 'Training apparel order',
    },
    {
      poNumber: 'PO-2026-0003',
      supplierId: suppliers[2].id,
      status: PurchaseOrderStatus.RECEIVED,
      notes: 'Football boots restock',
    },
    {
      poNumber: 'PO-2026-0004',
      supplierId: suppliers[3].id,
      status: PurchaseOrderStatus.DRAFT,
      notes: 'Basketball gear order',
    },
    {
      poNumber: 'PO-2026-0005',
      supplierId: suppliers[4].id,
      status: PurchaseOrderStatus.RECEIVED,
      notes: 'Gym equipment bulk',
    },
    {
      poNumber: 'PO-2026-0006',
      supplierId: suppliers[5].id,
      status: PurchaseOrderStatus.APPROVED,
      notes: 'Outdoor gear seasonal',
    },
    {
      poNumber: 'PO-2026-0007',
      supplierId: suppliers[6].id,
      status: PurchaseOrderStatus.CANCELLED,
      notes: 'Cancelled - budget hold',
    },
    {
      poNumber: 'PO-2026-0008',
      supplierId: suppliers[7].id,
      status: PurchaseOrderStatus.DRAFT,
      notes: 'Swimwear summer stock',
    },
  ];
  const pos = await Promise.all(
    poData.map(async (d) => {
      ...
      if (!exists)
        return poRepo.save(
          poRepo.create({ ...d, createdAt: now, updatedAt: now }),
        );
      return exists;
    }),
  );
  ...
  let poiCount = 0;
  for (const po of pos) {
    const existing = await poItemRepo.count({
  ...
  for (let i = 0; i < 5; i++) {
    ...
    if (!exists) {
      ...
      const cart = await cartRepo.save(
        cartRepo.create({ userId: u.id, subtotal: v.price, totalItems: 1 }),
      );
  ...
  for (let i = 0; i < 5; i++) {
    ...
    if (!exists) {
      const wl = await wlRepo.save(
        wlRepo.create({ userId: u.id, totalItems: 2 }),
      );
      await wlItemRepo.save(
        wlItemRepo.create({
          wishlistId: wl.id,
          productId: prods[i * 3].id,
          variantId: variants[i * 2].id,
        }),
      );
      await wlItemRepo.save(
        wlItemRepo.create({
          wishlistId: wl.id,
          productId: prods[(i * 3 + 1) % prods.length].id,
          variantId: variants[(i * 2 + 1) % variants.length].id,
        }),
      );
      wlCount++;
    }
  ...
  const orderData = [
    ...
    },
    {
      ...
      shippingAddressId: U.addr5,
      warehouseId: U.wh2,
    },
  ];
  const orderItemMap: Record<
    string,
    Array<{
      productId: string;
      variantId: string;
  ...
  > = {
    ...
    [U.order2]: [
      {
        ...
        productName: 'Adidas Running Ultraboost Light',
        sku: variants[6].sku,
        quantity: 1,
        unitPrice: 6399,
        totalPrice: 6399,
      },
      {
        ...
        productName: 'Nike Dri-FIT Training Tee',
        sku: variants[2].sku,
        quantity: 1,
        unitPrice: 1199,
        totalPrice: 1199,
    ...
    [U.order3]: [
      {
        productId: U.prod10,
        variantId: variants[18].id,
        productName: 'Columbia Voyager Jacket',
        sku: variants[18].sku,
        quantity: 2,
        unitPrice: 3599,
        totalPrice: 7198,
      },
      {
        ...
        productName: 'The North Face Hiking Boots',
        sku: variants[20].sku,
        quantity: 1,
        unitPrice: 4800,
        totalPrice: 4800,
    ...
    [U.order4]: [
      {
        ...
        productName: 'New Balance Fresh Foam 1080v12',
        sku: variants[14].sku,
        quantity: 1,
        unitPrice: 5199,
        totalPrice: 5199,
    ...
    if (!exists) {
      const pay = await payRepo.save(
        payRepo.create({
          ...
          transactionNumber: `TXN-${o.orderNumber}`,
          amount: o.totalAmount,
          status: PaymentStatus.PAID,
        }),
      );
      await payLogRepo.save(
        payLogRepo.create({
          paymentId: pay.id,
      ...
      if (o.paymentStatus === PaymentStatus.REFUNDED) {
        await payRefundRepo.save(
          payRefundRepo.create({
            paymentId: pay.id,
    ...
    if (!exists) {
      ...
      await trackRepo.save(
        trackRepo.create({
          shipmentId: s.id,
          status: s.status,
          note: `Shipment ${s.status.toLowerCase()}`,
        }),
      );
  ...
  const ticketData: Array<{
  ...
  }> = [
    {
      ...
      description:
        'I ordered size 42 but received size 44 in my running shoes.',
    },
    {
      id: U.ticket2,
      customerId: U.user2,
      ...
      description: 'My card was charged twice for order ORD-2026-00002.',
    },
    {
      id: U.ticket3,
      customerId: U.user3,
      ...
      subject: 'Product defect inquiry',
      description:
        'My Columbia jacket has a stitching defect on the left sleeve.',
    },
    {
      id: U.ticket4,
      customerId: U.user4,
      ...
      description: 'My order is delayed, when will it arrive?',
    },
    {
      id: U.ticket5,
      customerId: U.user5,
      ...
      category: TicketCategory.RETURN_ISSUE,
      subject: 'Return not processed',
      description: 'I returned my order 5 days ago but no refund yet.',
    },
  ];
  for (const d of ticketData) {
    const exists = await ticketRepo.findOne({
      where: { ticketNumber: d.ticketNumber },
    });
    if (exists) continue;
    ...
    if (d.status !== TicketStatus.OPEN) {
      ...
      await msgRepo.save(
        msgRepo.create({
          ...
          message: `Thank you for contacting us. We are looking into your issue regarding: ${d.subject}`,
        }),
      );
    }
    if (
      d.status === TicketStatus.RESOLVED ||
      d.status === TicketStatus.CLOSED
    ) {
      await msgRepo.save(
        msgRepo.create({
          ticketId: t.id,
          ...
          senderType: SenderType.ADMIN,
          message:
            'This ticket has been resolved. Please let us know if you need further assistance.',
        }),
      );
      await slaRepo.save(
        slaRepo.create({
    ...
    if (d.status === TicketStatus.CLOSED) {
      await tagTicketRepo.save(
        tagTicketRepo.create({ ticketId: t.id, tag: 'completed' }),
      );
    }
    await noteRepo.save(
      noteRepo.create({
        ticketId: t.id,
        note: `Initial ticket created by customer`,
        createdBy: adminId,
      }),
    );
    await auditRepo.save(
      auditRepo.create({
        ticketId: t.id,
        action: 'CREATED',
        performedBy: d.customerId,
      }),
    );
    await attRepo.save(
      attRepo.create({
        ticketId: t.id,
        fileUrl: 'https://picsum.photos/seed/ticket-attachment/400/300',
        fileName: 'issue-photo.jpg',
        uploadedBy: d.customerId,
      }),
    );
  }
  ...
  const retData = [
    {
      ...
      notes: 'Wrong shoe size delivered',
    },
    {
  ...
  for (const d of retData) {
    const exists = await retRepo.findOne({
      where: { returnNumber: d.returnNumber },
    });
    if (exists) continue;
    const rt = await retRepo.save(
      retRepo.create({ ...d, requestedAt: new Date() }),
    );
    const orderItems = await oiRepo.find({ where: { orderId: d.orderId } });
    if (orderItems.length > 0) {
      await retItemRepo.save(
        retItemRepo.create({
          returnRequestId: rt.id,
          orderItemId: orderItems[0].id,
          quantity: 1,
          reason: d.reason,
          condition: ReturnItemCondition.DAMAGED,
          refundAmount: orderItems[0].totalPrice,
        }),
      );
    }
    await retAuditRepo.save(
      retAuditRepo.create({
        returnRequestId: rt.id,
        action: 'CREATED',
        performedBy: null,
    ...
    if (
      d.status === ReturnRequestStatus.APPROVED ||
      d.status === ReturnRequestStatus.REFUNDED
    ) {
      await retAuditRepo.save(
        retAuditRepo.create({
          returnRequestId: rt.id,
      ...
      await revShipRepo.save(
        revShipRepo.create({
          returnRequestId: rt.id,
          courierName: 'Aramex',
          trackingNumber: `RET-TRK-${d.returnNumber}`,
  ...
  for (let i = 0; i < 10; i++) {
    ...
    const reviews = [
      'Really happy with this purchase. Quality exceeded expectations.',
      'Good product for the price. Shipping was fast.',
      'Perfect fit and comfortable. Will buy again.',
      'Decent quality but a bit pricey.',
      'Love the design and comfort level is great.',
      'Excellent build quality. Very satisfied.',
      'Expected better based on reviews. Okay for the price.',
      'Great purchase, fast delivery, exactly as described.',
      'Highly recommend to anyone looking for quality gear.',
      'Solid product, does what it says. Good value.',
    ];
    const ois = await oiRepo.find({ where: { orderId: o.id } });
    const oi = ois[i % ois.length];
    if (!oi) continue;
    const existingItemReview = await revRepo.findOne({
      where: { orderItemId: oi.id },
    });
    if (existingItemReview) continue;
    const r = await revRepo.save(
      revRepo.create({
        userId: u.id,
        productId: p.id,
        ...
        status: i < 8 ? ReviewStatus.APPROVED : ReviewStatus.PENDING,
        helpfulCount: Math.floor(Math.random() * 20),
      }),
    );
    await revImgRepo.save(
      revImgRepo.create({
        reviewId: r.id,
        imageUrl: `https://picsum.photos/seed/review-${i}/400/400`,
        sortOrder: 1,
      }),
    );
    if (i < 3) {
      const voter = users[(i + 3) % users.length];
      const vExists = await voteRepo.findOne({
        where: { reviewId: r.id, userId: voter.id },
      });
      if (!vExists)
        await voteRepo.save(
          voteRepo.create({ reviewId: r.id, userId: voter.id }),
        );
    }
  }
  ...
  const qData = [
    {
      productId: U.prod1,
      userId: U.user6,
      question: 'Is this shoe true to size?',
      status: QuestionStatus.ANSWERED,
    },
    {
      productId: U.prod3,
      userId: U.user7,
      question: 'Are these boots suitable for artificial grass?',
      status: QuestionStatus.ANSWERED,
    },
    {
      productId: U.prod6,
    ...
    },
    {
      productId: U.prod10,
      userId: U.user9,
      question: 'Is this jacket waterproof for heavy rain?',
      status: QuestionStatus.ANSWERED,
    },
    {
      productId: U.prod13,
      userId: U.user10,
      question: 'Does this jersey have player names on the back?',
      status: QuestionStatus.OPEN,
    },
    {
      productId: U.prod15,
      userId: U.user1,
      question: 'What is the thickness of this mat in mm?',
      status: QuestionStatus.ANSWERED,
    },
  ];
  for (const d of qData) {
    const exists = await qRepo.findOne({
      where: { productId: d.productId, userId: d.userId, question: d.question },
    });
    if (exists) continue;
    ...
    if (d.status === QuestionStatus.ANSWERED) {
      await aRepo.save(
        aRepo.create({
          ...
          userId: adminId,
          answer:
            'Thank you for your question. Yes, this product meets the expected standards. Please contact support for specific details.',
          isAdminAnswer: true,
        }),
      );
    }
  ...
  const promData = [
    {
      name: 'Summer Sale',
      description: 'Up to 30% off summer essentials',
    ...
    },
    {
      ...
      type: PromotionType.CART_DISCOUNT,
      discountValue: 10,
      isActive: true,
      priority: 3,
    },
  ...
  for (const d of promData) {
    ...
    if (!exists) {
      const prom = await promRepo.save(
        promRepo.create({
          ...d,
      ...
      if (prodIdx < prods.length) {
        await promProdRepo.save(
          promProdRepo.create({
            promotionId: prom.id,
            productId: prods[prodIdx].id,
          }),
        );
      }
      if (promData.indexOf(d) < 3) {
        await promCatRepo.save(
          promCatRepo.create({
            promotionId: prom.id,
            categoryId: cats[promData.indexOf(d)].id,
          }),
        );
      }
    }
  ...
  const campData = [
    {
      ...
      description: 'Promoting summer fitness gear',
      type: CouponCampaignType.SUMMER_SALE,
      discountValue: 15,
      isActive: true,
    },
    {
      name: 'Back to Sport',
      description: 'New season, new gear',
      type: CouponCampaignType.CUSTOM,
      discountValue: 10,
      isActive: true,
    },
    {
      name: 'Weekend Flash Sale',
      description: '48-hour flash sale',
      type: CouponCampaignType.CLEARANCE,
      discountValue: 25,
      isActive: true,
    },
  ];
  ...
  const etData = [
    {
      code: 'WELCOME_EMAIL',
      name: 'Welcome Email',
      subjectTemplate: 'Welcome to Sports!',
      bodyTemplate: '<h1>Welcome {{name}}!</h1><p>Thank you for joining.</p>',
      active: true,
    },
    {
      ...
      bodyTemplate:
        '<h1>Order Confirmed</h1><p>Your order #{{orderNumber}} has been placed.</p>',
      active: true,
    },
    {
      ...
      bodyTemplate: '<h1>Shipped!</h1><p>Track your order: {{trackingUrl}}</p>',
      active: true,
    },
    {
      code: 'RESET_PASSWORD',
      ...
      bodyTemplate:
        '<h1>Password Reset</h1><p>Click <a href="{{resetLink}}">here</a> to reset.</p>',
      active: true,
    },
  ];
  ...
  for (const o of orders) {
    ...
    const exists = await notifRepo.findOne({
      where: { recipientEmail: u.email, subject },
    });
    if (!exists) {
      const n = await notifRepo.save(
        notifRepo.create({
          ...
          subject,
          body: `Your order #${o.orderNumber} is ${o.status.toLowerCase()}.`,
          status: NotificationStatus.SENT,
          type: TransactionalEmailType.ORDER_CREATED,
          sentAt: new Date(),
        }),
      );
      await logRepo.save(
  ...
  const ecData = [
    {
      ...
      subject: 'Your Monthly Sports Update',
      body: '<h1>June Newsletter</h1><p>Check out our latest arrivals!</p>',
    ...
    },
    {
      ...
      body: "<h1>Summer Sale</h1><p>Don't miss out on our biggest sale of the season.</p>",
      type: EmailCampaignType.PROMOTIONAL,
  ...
  for (const o of orders) {
    ...
    if (!exists) {
      const ft = await ftRepo.save(
        ftRepo.create({
          transactionNumber: `FT-${o.orderNumber}`,
          type: TransactionType.ORDER_PAYMENT,
          amount: o.totalAmount,
          status:
            o.paymentStatus === PaymentStatus.PAID ? 'COMPLETED' : 'PENDING',
          referenceType: 'ORDER',
          referenceId: o.id,
  ...
  const settData = [
    {
      settlementNumber: 'STL-2026-00001',
      supplierId: suppliers[0].id,
      amount: 50000,
      status: SettlementStatus.COMPLETED,
      settlementDate: new Date('2026-06-01'),
      dueDate: new Date('2026-06-15'),
      description: 'Monthly payment - Nike products',
    },
    {
      settlementNumber: 'STL-2026-00002',
      supplierId: suppliers[1].id,
      amount: 35000,
      status: SettlementStatus.PENDING,
      settlementDate: new Date('2026-06-15'),
      dueDate: new Date('2026-06-30'),
      description: 'Training apparel settlement',
    },
    {
      settlementNumber: 'STL-2026-00003',
      supplierId: suppliers[2].id,
      amount: 75000,
      status: SettlementStatus.PROCESSING,
      settlementDate: new Date('2026-06-10'),
      dueDate: new Date('2026-06-25'),
      description: 'Football equipment settlement',
    },
  ];
  for (const d of settData) {
    const exists = await settRepo.findOne({
      where: { settlementNumber: d.settlementNumber },
    });
  ...
  const expData = [
    {
      ...
      description: 'Warehouse rent June 2026',
    ...
    },
    {
      ...
      description: 'Shipping partner fees',
      vendorName: 'Aramex',
      createdBy: adminId,
    },
    {
  ...
  for (const d of expData) {
    const exists = await expRepo.findOne({
      where: { description: d.description, expenseDate: d.expenseDate },
    });
  ...
  for (const o of orders) {
    ...
    if (!exists)
      await taxRepo.save(
        taxRepo.create({
          orderId: o.id,
          taxableAmount: o.totalAmount,
          taxAmount: Math.round(o.totalAmount * 0.05),
          taxRate: 5,
          taxType: 'VAT',
          taxDate: new Date(),
        }),
  ...
  const faData = [
    ...
    },
    {
      ...
      entityId: null,
      performedBy: adminId,
      details: { status: 'audited' },
      notes: 'Q2 settlement audit',
    },
  ];
  ...
  const dashData = [
    {
      snapshotDate: new Date('2026-06-15'),
    ...
    {
      snapshotDate: new Date('2026-06-14'),
      dashboardType: DashboardType.MAIN,
      metricsJson: {
        totalRevenue: 118000,
        totalOrders: 42,
  ...
  const srData = [
    {
      ...
      filtersJson: { dateRange: 'last_30_days' },
      createdBy: adminId,
    },
    {
      name: 'Top Products Q2',
      reportType: ReportType.PRODUCTS,
      filtersJson: { period: 'Q2_2026', limit: 10 },
      createdBy: adminId,
    },
    {
      name: 'Customer Acquisition',
      reportType: ReportType.CUSTOMERS,
      filtersJson: { channel: 'all' },
      createdBy: adminId,
    },
  ];
  for (const d of srData) {
    const exists = await srRepo.findOne({
      where: { name: d.name, createdBy: d.createdBy },
    });
  ...
  const seData = [
    ...
    },
    {
      ...
      userId: U.user6,
      details: { reason: 'excessive_failures' },
      ipAddress: '10.0.0.99',
    },
  ];
  ...
  const prData = [
    {
      userId: U.user6,
      requestType: PrivacyRequestType.EXPORT_DATA,
      status: PrivacyRequestStatus.COMPLETED,
      processedAt: new Date(),
    },
    {
      userId: U.user7,
      requestType: PrivacyRequestType.DELETE_ACCOUNT,
  ...
  for (const u of users.slice(0, 5)) {
    const exists = await crRepo.findOne({
      where: { userId: u.id, consentType: ConsentType.MARKETING },
    });
    if (!exists) {
      await crRepo.save(
        crRepo.create({
  ...
  const cmsData = [
    {
      ...
      slug: 'about-us',
      content:
        '<h1>About Sports E-Commerce</h1><p>Your one-stop shop for premium sports gear.</p>',
      status: CmsPageStatus.PUBLISHED,
      pageType: CmsPageType.ABOUT_US,
    },
    {
      ...
      status: CmsPageStatus.PUBLISHED,
      pageType: CmsPageType.PRIVACY_POLICY,
    },
    {
      title: 'Terms & Conditions',
      slug: 'terms-conditions',
      content:
        '<h1>Terms & Conditions</h1><p>Please read these terms carefully.</p>',
      status: CmsPageStatus.PUBLISHED,
      pageType: CmsPageType.TERMS_AND_CONDITIONS,
    },
    {
      title: 'Shipping Information',
      slug: 'shipping-info',
      content:
        '<h1>Shipping Info</h1><p>Free shipping on orders over 200 AED.</p>',
      status: CmsPageStatus.PUBLISHED,
      pageType: CmsPageType.CUSTOM_PAGE,
    },
  ];
  ...
  const hsData = [
    {
      ...
      contentJson: {
        heading: 'Summer Sale!',
        subheading: 'Up to 40% off',
        ctaText: 'Shop Now',
        ctaLink: '/collections/summer-essentials',
        bgColor: '#1a1a2e',
      },
      sortOrder: 1,
    },
    {
      ...
      contentJson: {
        ...
        productIds: [U.prod1, U.prod3, U.prod4, U.prod10, U.prod13].join(','),
      },
      sortOrder: 2,
    },
    {
      sectionKey: 'categories_grid',
      title: 'Shop by Category',
      contentJson: { heading: 'Shop by Sport' },
      sortOrder: 3,
    },
    {
      sectionKey: 'new_arrivals',
      title: 'New Arrivals',
      contentJson: { heading: 'Just Landed' },
      sortOrder: 4,
    },
    {
      sectionKey: 'brands_carousel',
      title: 'Brands',
      contentJson: { heading: 'Premium Brands' },
      sortOrder: 5,
    },
  ];
  for (const d of hsData) {
    const exists = await hsRepo.findOne({
      where: { sectionKey: d.sectionKey },
    });
  ...
  if (csExists === 0) {
    await csRepo.save(
      csRepo.create({
        email: 'support@sports.com',
        phone: '+97148000000',
        address: 'Dubai, UAE',
        supportHours: 'Mon-Sat 9AM-9PM GST',
      }),
    );
  }
  ...
  if (scExists === 0) {
    await scRepo.save(
      scRepo.create({
        siteName: 'Sports E-Commerce',
        logoUrl: 'https://via.placeholder.com/200x60?text=Sports',
  ...
  const saData = [
    {
      ...
      newQuantity: 95,
      reason: 'Damaged stock - water damage',
      adjustedBy: adminId,
    },
    {
      variantId: variants[2].id,
      previousQuantity: 80,
      newQuantity: 82,
      reason: 'Found miscount during audit',
      adjustedBy: adminId,
    },
    {
      ...
      previousQuantity: 60,
      newQuantity: 55,
      reason: 'Quality check failed items removed',
      adjustedBy: adminId,
    },
  ];
  ...
  const iaData = [
    {
      ...
      notes: 'Minor discrepancy corrected',
      performedBy: adminId,
    },
    {
  ...
  for (let i = 0; i < 3; i++) {
    const coupon = await coupRepo.findOne({
      where: { code: ['WELCOME10', 'SPORTS20', 'FLAT500'][i] },
    });
    if (coupon) {
      const exists = await cuRepo.findOne({
        where: {
          couponId: coupon.id,
          userId: users[i].id,
          orderId: orders[i].id,
        ...
        await cuRepo.save(
          cuRepo.create({
            ...
            discountAmount: Math.round(
              orders[i].totalAmount * (coupon.value / 100),
            ),
            usedAt: new Date(),
          }),
        );
  ...
  const dcData = [
    {
      ...
      chargeAmount: 99,
      chargeType: DeliveryChargeType.FIXED_DELIVERY,
      isActive: true,
      createdBy: adminId,
    },
    {
      ...
      chargeAmount: 2000,
      chargeType: DeliveryChargeType.FREE_SHIPPING_THRESHOLD,
      isActive: true,
      createdBy: adminId,
    },
    {
      name: 'COD Charge',
      description: 'Additional charge for Cash on Delivery orders',
      chargeAmount: 49,
      chargeType: DeliveryChargeType.COD_CHARGE,
      isActive: true,
      createdBy: adminId,
    },
    {
      name: 'Handling Charge',
      description: 'Handling fee for order processing',
      chargeAmount: 0,
      chargeType: DeliveryChargeType.HANDLING_CHARGE,
      isActive: false,
      createdBy: adminId,
    },
  ];
  for (const d of dcData) {
    const exists = await dcRepo.findOne({
      where: { chargeType: d.chargeType },
    });
